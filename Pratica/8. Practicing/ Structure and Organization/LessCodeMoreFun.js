...
var vs = `#version 300 es
  ...
  uniform   mat4  u_viewInverse; // Adicionado
  ...
  out       vec4  v_position;
  out       vec2  v_texCoord;
  out       vec3  v_normal; // Alterado para vec3
...
function main () {
  ...
  var vao = twgl.createVAOAndSetAttributes( gl, programInfo.attribSetters, attribs, buffers.indices);
  ...
  function render(time) {
    ...
    // Computa a matriz da Camera com o LookAt
    ...
    twgl.setUniforms(programInfo.uniformSetters, uniformsThatAreTheSameForAllObjects);

    objects.forEach(function(object) {

      // Computa a posição para esse objeto, baseado no tempo
      ...
      // Define os uniforms computados
      twgl.setUniforms(programInfo, uniformsThatAreComputedForEachObject);
      
      // Define os Uniformes específicos para esse objeto
