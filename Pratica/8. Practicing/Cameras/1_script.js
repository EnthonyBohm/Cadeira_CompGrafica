...
function main() {
  ...
  function drawScene() {
    ...
    // Cria uma matrix de visualização ao redor da Inversa da Câmera, dessa forma o mundo se moverá ao redor dela.
    var viewMatrix = m4.inverse ( cameraMatrix );

    // Cria Matriz de Projeção de vista. Aplica Perspectiva e define a câmera como Origem quanod mundo se move.
