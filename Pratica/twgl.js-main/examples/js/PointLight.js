...
void main() {
  ...
  // Computa a worldPosition da Superficie
  vec3 surfaceWorldPosition = (u_world * a_position).xyz;

  // Computa o vetor da superficie voltada para a luz e passa para o fragment Shader
...
function main() {
  ...
  function drawScene() {
    ...
    // Define a Cor da Luz
    gl.uniform3fv (lightColorLocation, m4.normalize([0.5, 0.4, 0.2])); 

    gl.uniform3fv (specularColorLocation, m4.normalize ([0.4, 0.6, 1.0]));
